...
document.querySelector('#auth-form')?.addEventListener('submit', async event => {
  ...
  send.disabled = true;
  /* zapamatovat, odkud člověk odešel, ať se po potvrzení vrátí sem */
  try { localStorage.setItem('atlas_navrat', window.location.pathname + window.location.search); } catch (_) {}
