...
(function () {
  ...
  const EN = {
    ...
    'energetických míst': 'of Energetic Places',   /* značka v hlavičce: „Atlas" + zvýrazněná část */
    ...
    'O místě': 'About the place',
    'Upravit místo': 'Edit place',
    'Přeložit': 'Translate',
    'Překládám…': 'Translating…',
    'Skrýt překlad': 'Hide translation',
    'strojový překlad': 'machine translation',
    'Překlad se teď nepovedl. Zkus to za chvíli.': 'Translation failed. Try again in a moment.',
    'Úprava místa': 'Editing a place',
    'Uprav své místo': 'Edit your place',
    'Název, vyprávění i štítky můžeš měnit kdykoli. Poloha místa zůstává tam, kde jsi ji zanesl — s ní ti pomůže správce.': 'You can change the name, the story and the tags anytime. The location stays where you first recorded it — the keeper can help you with that.',
    'Název nemůže zůstat prázdný.': 'The name can\u2019t be left empty.',
    'Místo upraveno 🌿': 'Place updated 🌿',
    'Uložení se nepodařilo:': 'Saving failed:',
    'Změny se neuložily — nemáš k nim oprávnění, nebo vypršelo přihlášení.': 'The changes weren\u2019t saved — you don\u2019t have permission, or your sign-in expired.',
    'Ověřeno na místě': 'Verified on site',
    'Poloha načtena': 'Location captured',
    'Hledám polohu…': 'Finding your location…',
    'Načíst polohu znovu': 'Get the location again',
    'Návštěva ponese odznak ◎ ověřeno na místě.': 'This visit will carry the ◎ verified-on-site badge.',
    'Tohle místo už máš ověřené. Odznak platí napořád — další návštěvu zapíšeš rovnou.': 'You\u2019ve already verified this place. The badge is permanent — just log your next visit straight away.',
    ...
    'místo čeká na schválení': 'place awaiting approval',
    'místa čekají na schválení': 'places awaiting approval',
    'míst čeká na schválení': 'places awaiting approval',
    'komentář čeká na schválení': 'comment awaiting approval',
    'komentáře čekají na schválení': 'comments awaiting approval',
    'komentářů čeká na schválení': 'comments awaiting approval',
    'otevřít Správu Atlasu ›': 'open Atlas Admin ›',
    'čeká na objevení': 'awaiting discovery',
    'navštíveno': 'visited',
    'Tvé návštěvy': 'Your visits',
    'Tvá návštěva': 'Your visit',
    'naposledy': 'last',
    'ověřeno': 'verified',
    'Upravit naladění': 'Edit attunement',
    'Úprava návštěvy': 'Edit visit',
    'Uprav své naladění': 'Adjust your attunement',
    'Změna pěti os se hned promítne do DNA místa. Datum návštěvy i ověření ◎ zůstávají.': 'Changing the five axes updates the place\u2019s DNA right away. The visit date and the ◎ verification stay unchanged.',
    'Naladění upraveno 🌿': 'Attunement updated 🌿',
    'Komentář je na zdi 🌿': 'Your comment is on the wall 🌿',
    'Úprava se nepodařila:': 'The edit failed:',
    ...
    'Když návštěvu ověříš polohou přímo na místě, ponese odznak ◎ ověřeno na místě — je to nepovinný bonus a u každého místa se získává jednou. Vracet se a zapisovat další návštěvy můžeš, kolikrát chceš; každá znovu naladí DNA místa.': 'If you verify a visit with your location right at the spot, it will carry the ◎ verified-on-site badge — an optional bonus, earned once per place. You can come back and log as many further visits as you like; each one retunes the place\u2019s DNA.',
    ...
    'Projdeš mapu podle sebe, nebo se necháš vést seznamem míst — a čteš, co o nich napsali ti před tebou.': 'Wander the map your own way, or let the list of places guide you — and read what those before you wrote about them.',
